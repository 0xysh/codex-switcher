  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[var(--bg-overlay)] px-4">
      <div
        ...
        ref={dialogRef}
        className="surface-panel-strong w-full max-w-xl overflow-hidden overscroll-contain shadow-[var(--shadow-raised)]"
      >
        <header className="border-b border-[var(--border-soft)] bg-[var(--bg-surface-elevated)] px-6 py-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-2 inline-flex items-center gap-1 rounded-full border border-[var(--accent-border)] bg-[var(--accent-soft)] px-2.5 py-1 text-xs font-semibold text-[var(--accent-primary)] shadow-[0_8px_18px_rgb(37_99_235_/_.16)]">
        ...
        <footer className="flex flex-col-reverse gap-3 border-t border-[var(--border-soft)] bg-[var(--bg-surface-elevated)] px-6 py-5 sm:flex-row sm:justify-end">
